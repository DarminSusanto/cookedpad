...
function EditRecipe() {
    ...
    try {
      ...
      if (response.data.success) {
        ...
        setFormData({
          ...
          instructions: recipe.instructions || [{ step: 1, description: '', image: '' }],
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError('Gagal memperbarui resep: ' + (error.response?.data?.message || error.message));
    } finally {
      setLoading(false);
    }
  };
  ...
  if (loading) {
    return (
      <div style={{ textAlign: 'center', padding: '50px' }}>
        ...
        <p style={{ marginTop: '20px' }}>Memuat resep...</p>
      </div>
    );
  }

  return (
    <div className="edit-recipe-page" style={{ marginBottom: '100px' }}>
      <h1 className="page-title">Edit Resep</h1>
